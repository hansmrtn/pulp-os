...
// build-time font rasterisation: scan assets/fonts/ for TTFs, classify by
// weight/style, rasterise ASCII 0x20-0x7E to 1-bit bitmaps, emit font_data.rs.
...
const BODY_PX_MEDIUM: f32 = 24.0;
const BODY_PX_LARGE: f32 = 30.0;
// heading sizes scale with body index: Small=22, Medium=32, Large=40
const HEADING_PX_SMALL: f32 = 22.0;
const HEADING_PX_MEDIUM: f32 = 32.0;
...
fn generate_bitmap_fonts() {
    ...
    // header (clippy suppression lives on the module decl in fonts/mod.rs)
